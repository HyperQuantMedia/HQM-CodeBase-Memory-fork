...
TEST(cli_skill_files_content) {
    ...
    /* 16 on this fork: upstream's 15 plus ingest_overlay. Count-coupled assertions
     * like this one are why the census is stated in one place and the list is the
     * authority — see the note beside the tool list in src/cli/cli.c. */
